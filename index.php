			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4 col-xl-3">
					...
					<div class=" bg-white">
						...
						<div class="row">
							<div class="col-4">
								<a href=""><img src="https://twitter.local/img/avatar.jpg" class="rounded-circle"></a>
							</div>
							<div class="col-8">
								<div>
									<a href="">Mary Smith</a>
				...
				<div class="col-sm-12 col-md-8 col-xl-6" style="">
					<div class="pt-2 bg-white">
						<div class="row">
							<div class="col-2">
								<img src="https://twitter.local/img/avatar.jpg" class="rounded-circle">
							</div>
							<div class="col-10">
								<!-- 
								...
								<form action="index.php" method="GET">
									<input type="" name="name" class="form-control mt-2">
									<textarea name="newpost" class="form-control mt-2"></textarea>
									<button class="btn btn-primary mt-2">Твитнуть</button>
								</form>
							</div>
						</div>
						<!-- новый пост -->
						...
						<div class="row mt-4">
							...
							<div class="col-xl-10">
								...
								<div>
									...
									-->	
									<img src= <?php echo $post1["img"];?> class="w-75">
								</div>
							</div>
						</div>
						<div class="row mt-4">
							...
							<div class="col-xl-10">
								...
								<div>
									...
									-->	
									<img src= <?php echo $post2["img"];?> class="w-75">
								</div>
							</div>
						</div>
					</div>
					<div class="row mt-4">
							...
							<div class="col-xl-10">
								...
								<div>
									...
									-->	
									<img src= <?php echo $post3["img"];?> class="w-75">
								</div>
							</div>
						</div>
				</div>
					...
					<div class="bg-white pt-3 pb-3 pl-3 pr-3">
						...
						<div class="row mb-3">
							<div class="col-4">
								<a href=""><img class="w-100 rounded-circle" src="https://twitter.local/img/1.jpg"></a> <!-- аватарка, внутри ссылки картинка-->
							</div>
							<div class="col-xl-8">
								<div>
						...
						<div class="row mb-3">
							...
							<div class="col-4">
								<a href=""><img class="w-100 rounded-circle" src="https://twitter.local/img/2.jpg"></a> <!-- аватарка, внутри ссылки картинка-->
							</div>
							<div class="col-xl-8">
								<div>
